...
export default function WhatIsML() {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 text-gray-800">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 text-center text-blue-700">
        ML Introduction
      </h1>
      ...
      <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-blue-600">What is Machine Learning?</h2>
      <p className="mb-6 text-base sm:text-lg leading-relaxed">
        Machine Learning (ML) is a field of computer science that gives machines the ability to learn from data and experiences—much like humans do—and make predictions or decisions without being explicitly programmed to perform those tasks.
      </p>

      <h2 className="text-xl sm:text-2xl font-semibold mb-4 text-blue-600">How it Differs from Traditional Programming</h2>

      <div className="overflow-x-auto">
        <table className="w-full border border-gray-300 text-sm sm:text-base">
          <thead>
            <tr className="bg-gray-100 text-left">
              <th className="border border-gray-300 px-4 py-2">Traditional Programming</th>
              <th className="border border-gray-300 px-4 py-2">Machine Learning</th>
            </tr>
          </thead>
          <tbody>
            <tr>
